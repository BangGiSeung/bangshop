   ...
   <div class="container mt-3" style="margin-top: 0 !important; margin-bottom: 50px; width: 1300px;">
      ...
      <div style="float: left; margin-right: 100px;">
         <div class="w3-content w3-display-container">
            <img class="mySlides" src="<%=realFolder%>/<%=product.getImage()%>" alt="상품이미지 준비중">
            <img class="mySlides" src="<%=request.getContextPath()%>/img/logo.PNG">
      ...
      <div style="height: 500px;">
         ...
         <button class="w3-btn w3-border w3-xlarge w3-red" style="width: 200px; margin-right: 27px;">
         <a href="<%=request.getContextPath()%>/shop/shopping/store/jjimPro.jsp?no=<%=product.getProNo()%>">찜</a></button>
