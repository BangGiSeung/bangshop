      ...
      <nav class="navbar navbar-expand-sm justify-content-center"
         ...
         <ul class="navbar-nav" style="width: 100%;">
            <li style="margin-left: 40px; margin-right: 10px;">
               <input class="form-control mr-sm-2" type="text" placeholder="찾을 물건을 입력하세요." size="50" id="ii"
                  style="font-style: italic; border-color: white;">
            </li>
            <li style="margin-right: 150px;">
               <button class="btn btn-light" type="submit" style="font-style: italic; color: #003399;">
                  <b>Search</b>
               </button>
            </li>
